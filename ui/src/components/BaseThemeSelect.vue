<template>
  <div class="dropdown dropdown-hover dropdown-bottom dropdown-end">
    ...
    <ul
      tabindex="0"
      class="z-40 dropdown-content menu shadow-md text-base-content rounded-box bg-base-100 max-h-64 overflow-scroll flex-nowrap"
    >
      <li
      ...
      >
        <a
          class="w-full py-2 px-4 capitalize"
