...
use crate::post::*;
use crate::votes::*;
use crate::{Comment, EntryTypes, LinkTypes, Post};
use hdi::prelude::*;
    ...
    match op.to_type::<EntryTypes, LinkTypes>()? {
        ...
        OpType::RegisterDeleteLink {
            ...
            match link_type {
                ...
                LinkTypes::MyPosts => validate_delete_link_my_posts(
                    action,
                    original_action,
                    base_address,
                    target_address,
                ...
                // Comments
                LinkTypes::MyComments => validate_link_deleted_by_author(
                    action,
                    original_action,
                    base_address,
                    target_address,
                ...
                // Post Votes
                LinkTypes::PostVoteByAgent => validate_link_deleted_by_author(
                    action,
                    original_action,
                    base_address,
                    target_address,
                ...
                LinkTypes::MyVotedPosts => validate_link_deleted_by_author(
                    action,
                    original_action,
                    base_address,
                    target_address,
                ...
                // Comment Votes
                LinkTypes::CommentVoteByAgent => validate_link_deleted_by_author(
                    action,
                    original_action,
                    base_address,
                    target_address,
                ...
                LinkTypes::MyVotedComments => validate_link_deleted_by_author(
                    action,
                    original_action,
                    base_address,
                    target_address,
